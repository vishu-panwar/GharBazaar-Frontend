    ...
    <div className="min-h-screen bg-black">
      ...
      <section className="relative h-screen overflow-hidden">
        ...
        <div className="relative z-10 h-full max-w-[1400px] mx-auto px-8">
          <div className="h-full grid lg:grid-cols-12 gap-8 items-start lg:items-center pt-24 sm:pt-28 lg:pt-20">
            ...
            <motion.div
              ...
              className="lg:col-span-7 space-y-4 sm:space-y-5 lg:pl-12 xl:pl-16"
            >
